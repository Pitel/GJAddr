...
public class Settings {
    ...
    /**
     * Method for change current persistance. Switch between binary and XML. Always changed one type
     * to the other.
     */
    ...
    /**
     * Changed displaying first firstname or surname. Method changed the current state to the second
     * value.
     */
