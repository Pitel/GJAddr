...
public class DatabaseGroups {
  ...
  private String getFilename() {
    return new File(Settings.instance().getDataDir(), "groups").getPath();
  }
  ...
  private void load() {
    ...
    this.groups = (ArrayList<Group>) per.loadData(this.getFilename());
  }
  ...
  void save() {
    Persistance per = new Persistance();
    per.saveData(this.getFilename(), this.groups);
  }
